...
export default async (req) => {
  ...
  const body = sub
    ? `<h1>Thank you for your support</h1><p>Your alerts are on. We'll alert you when a call is dispatched inside your area. We also emailed you this link. Bookmark it to change your places or cancel your support:</p>
